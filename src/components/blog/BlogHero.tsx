...
const BlogHero = ({ query }: { query?: string }) => {
	return (
		<section className='text-darkText  max-w-screen flex flex-col justify-start items-center w-full md:pt-16'>
			<div className='mb-9 md:mb-12'>
				<h1 className='text-center font-bold text-4xl md:text-[56px] text-darkText'>
					Blogs
				</h1>
